...
with xr.open_dataset(file_path) as ds:
    ...
    uuu_850 = ds['u'].sel(pressure_level=850, valid_time=TAG_TIME) 
    vvv_850 = ds['v'].sel(pressure_level=850, valid_time=TAG_TIME) 
...
p2d(
    ...
    show=False,
    o="./p2d_sample_code/998/fig1.png"
)